...
import classes from "./IndexBookBlitz.module.css";
import MenuItem from "@mui/material/MenuItem";
import Select from "@mui/material/Select";
import Shared from "./Shared";

const IndexBookBlitz = () => {
  return (
    <Box className={classes.bookBlitz_page}>
