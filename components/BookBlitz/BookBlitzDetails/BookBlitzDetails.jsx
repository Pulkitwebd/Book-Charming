...
import { BookBlitzContext } from "../../../pages/book-blitz/[slug]";
import bookBlitz_fullpage from "../../../public/images/bookBlitz_fullpage.png";
import bookBlitzAuthor from "../../../public/images/bookBlitzAuthor.png";
import { Box, Typography, Stack, Divider } from "@mui/material";
import CommentBox from "../../shared/CommentBox/CommentBox";
import classes from "./BookBlitzDetails.module.css";
import SocialIcons from "../../shared/SocialIcons";
import fullPageData from "../Data";
import Image from "next/image";

const BookBlitzDetails = () => {
  const [bookBlitzs, setBookBlitzs] = useState(fullPageData);

  const bookBlitzSlug = useContext(BookBlitzContext);

  var gettingData = () => {
    var BookReviewArray = bookBlitzs.find(
      (bookBlitz) => bookBlitz.slug === bookBlitzSlug
    );
  ...
  return (
    <Box className={classes.bookBlitz_fullpage}>
      ...
      <Box className={classes.mainImgAndDetails}>
        <Box className={classes.mainImageBox}>
          <Image src={bookBlitz_fullpage}></Image>
        </Box>
        ...
        <Box className={classes.bookDetails}>
          ...
          <Box>
            <Stack className={`${classes.stack} playfairFont`}>
              ...
              <Box>Tellwell Talent</Box>
              <Box>Tellwell Talent</Box>
              <Box style={{ color: "#3687ff" }}>
                Amazon<i className="fa-solid fa-arrow-up-right"></i>
              </Box>
            </Stack>
          </Box>
        </Box>
      ...
      <Box className={classes.aboutAuthor_box}>
        <Box className={classes.imageBox}>
          <Image src={bookBlitzAuthor}></Image>
...
export default BookBlitzDetails;
